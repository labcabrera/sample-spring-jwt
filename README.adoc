...
directamente en lugar de hacerlo vía POST con estructura JSON. Aquí preparar a gusto del consumidor.
...
Podría cambiarse este comportamiento. Tenemos varios ejemplos en la clase de pruebas de rendimiento
